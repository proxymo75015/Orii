...
class GestureSkipTrackFragment : TutorialFragment() {

    companion object {
        @JvmStatic
        fun newInstance(): GestureSkipTrackFragment = GestureSkipTrackFragment()
    }

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?
    ): View? = inflater.inflate(R.layout.fragment_gesture_skip_track, container, false)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        val imageRequest: ImageRequest = ImageRequestBuilder
            .newBuilderWithResourceId(R.raw.gesture_skip_track)
            .build()
