...
class ReadoutFragment : TutorialFragment() {

    companion object {
        @JvmStatic
        fun newInstance(): ReadoutFragment = ReadoutFragment()
    }

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?
    ): View? = inflater.inflate(R.layout.fragment_readout, container, false)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        val imageRequest: ImageRequest = ImageRequestBuilder.newBuilderWithResourceId(R.raw.message_readout).build()
