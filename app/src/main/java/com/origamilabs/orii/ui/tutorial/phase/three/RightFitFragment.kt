...
class RightFitFragment : TutorialFragment() {

    companion object {
        @JvmStatic
        fun newInstance(): RightFitFragment = RightFitFragment()
    }

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?
    ): View? = inflater.inflate(R.layout.fragment_right_fit, container, false)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        val imageRequest: ImageRequest = ImageRequestBuilder
            .newBuilderWithResourceId(R.raw.right_fit)
            .build()
