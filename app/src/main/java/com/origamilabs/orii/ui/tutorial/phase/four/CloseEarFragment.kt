...
class CloseEarFragment : TutorialFragment() {

    companion object {
        @JvmStatic
        fun newInstance(): CloseEarFragment = CloseEarFragment()
    }

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?
    ): View? = inflater.inflate(R.layout.fragment_close_ear, container, false)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        val imageRequest: ImageRequest = ImageRequestBuilder
            .newBuilderWithResourceId(R.raw.close_ear)
            .build()
        controllerBuilder
